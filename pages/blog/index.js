...
import { Container, Menu, Segment, Image, Divider, Grid, Icon, Breadcrumb, Search } from "semantic-ui-react";
...
function blog() {
  ...
  function selectCategory(category) {
    if (category != "All") {
      changeCategory( state.pages.data.filter(page => (page.categories.length > 0 ? page.categories[0].name === category : false)));
    }
    else {
  ...
  return (
              ...
              <Menu borderless style={{ border: 'none', boxShadow: 'none' }} className="blog-nav-menu">
                <Link href="/">
                  <Menu.Item header style={{ marginLeft: '-21px' }}>
                    <Image src="https://res.cloudinary.com/dnzambf4m/image/upload/v1589058160/authorize_title_fx3yxd_ur1vnf_tcdnmx.jpg" style={{ width: '42px', marginTop: '1.5em' }} />
                  </Menu.Item>
                </Link>
                <Link href="/">
                  <Menu.Item position='right' header style={{ marginRight: '-15px' }}>
                    <Breadcrumb style={{ borderRadius: '4px', color: 'rgb(97, 97, 97)', paddingTop: '20px', fontWeight: 'normal' }}> Go to Decentral Games <Icon style={{ fontSize: '10px', color: 'rgb(97, 97, 97)' }} name="arrow right" /> </Breadcrumb>
                  </Menu.Item>
                </Link>
              </Menu>
            </Container>
            <Container>
              <div className="blog-hero-text">
                ...
                <Fade bottom distance="10px" duration={600} delay={200}>
                  <h5 className="blog-hero" style={{ color: 'grey', paddingTop: '6px' }}> Check back here regularly for updates on our technology, tutorials, and Decentral Games news. </h5>
                </Fade>
              </div>
                    ...
                    <Grid style={{ paddingBottom: '120px' }} className="featured-post-padding">
                      <Grid.Row>
                        <Grid.Column computer={11} tablet={16} mobile={16}>
                          <Image src="https://res.cloudinary.com/dnzambf4m/image/upload/v1589058170/tominoya_w11amn_qqrzy3_zibqbw.jpg" className="featured-image"/>
                        </Grid.Column>
                          ...
                          <div className="post-info">
                            ...
                            <div className="bottom">
                              <div className="blog-title">
                                <h4 style={{ paddingBottom: '9px', paddingTop: '8px', color: 'black' }}>Tominoya Casino NFT Sale</h4>
                                <p style={{ color: 'rgb(97, 97, 97)', fontSize: '18px' }}>Tominoya is a 3D virtual casino built by Decentral Games on 52 LAND parcels within Decentraland's Vegas City district.</p>
                              </div>
                            </div>
                          </div>
                        </Grid.Column>
                ...
                <div className="ui container">
                  <div className="dcl navbar-menu">
                    <div className="ui secondary stackable menu">
                      ...
                      <a aria-current="page" className="item active" id="All" onClick={() => selectCategory("All")}>All Articles</a>
                      <a className="item" id="Announcements" onClick={() => selectCategory("Announcements")}>Announcements</a>
                      <a className="item" id="Tutorials" onClick={() => selectCategory("Tutorials")}>Tutorials</a>
                      <a className="item" id="Technology" onClick={() => selectCategory("Technology")}>Technology</a>
                    </div>
                  </div>
              ...
              <div className="dcl navbar menu-mobile" role="navigation">
                <div className="mobile-menu">
                  ...
                  <div className="mobile-menu-items menu-hide">
                    <a aria-current="page" className="item active" onClick={() => selectCategory("All")} id="mobile-All">All Articles</a>
                    <a className="item" id="mobile-Announcements" onClick={() => selectCategory("Announcements")}>Announcements</a>
                    <a className="item" id="mobile-Tutorials" onClick={() => selectCategory("Tutorials")}>Tutorials</a>
                    <a className="item" id="mobile-Technology" onClick={() => selectCategory("Technology")}>Technology</a>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <a className="post">
                    <Container className="post-container" >
                      ...
                      <div className="post-info">
                        <div className="top">
                          <div className="date">
                            <span>{new Date(page.created).toLocaleDateString("en-DE", { day: "numeric", month: "short", year: "numeric" })}</span>
                          </div>
                        ...
                        <div className="bottom">
                          <div className="blog-title">
                            ...
                            <p style={{ color: 'rgb(97, 97, 97)', fontSize: '18px' }}>{page.summary.split('.', 1)[0]}</p>
                          </div>
                        </div>
                      </div>
                    </Container>
      ...
      <Container className="outter-blog-container">
        <div className="blog-footer-container">
          <p className='small-footer-p'> © 2020 <a id='a-footer-small' href='/'> Decentral Games </a></p>
          <p className='small-footer-p'> Follow <a id='a-footer-small' href='https://twitter.com/decentralgames'> Twitter </a> & Join <a id='a-footer-small' href='https://decentral.games/discord/'> Discord </a> | <a id='a-footer-small' href='/disclaimer'> Disclaimer </a></p>
        </div>
      </Container>
    </Segment>
  );
