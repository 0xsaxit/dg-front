    ...
    <div className="blog-home-container">
      <span style={{ display: 'flex', justifyContent: 'space-between', paddingTop: '0px' }}>
        <span style={{ borderBottom: '1px solid #2085f4' }}>
          <p className="featured-text" style={{ marginBottom: '15px' }}>FEATURED POST</p>
        </span>
      </span>
      ...
      {categories.map((category, index) => ( categoryURL = category.toLowerCase(),
        <div>
          <span style={{ display: 'flex', justifyContent: 'space-between', paddingTop: '30px' }}>
            <span style={{ borderBottom: '1px solid #2085f4' }}>
          ...
          <Divider id="blog-divider" style={{ paddingBottom: '15px', marginTop: '-1px' }} />
            ...
            <div className="posts">
                { count = 0, filteredPages.map((page) => ( category === 'ALL' ?
                <Link
                    href="/blog/[id]"
                    key={page.created}
                    as={`/blog/${page.slug}`}
                ...
                : count <= 5 && page.categories[0].name === category ?  (count += 1,
                <Link
                    href="/blog/[id]"
                    key={page.created}
                    as={`/blog/${page.slug}`}
