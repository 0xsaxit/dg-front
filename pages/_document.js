    ...
    render() {
        return (
            ...
            <Head>
                ...
                <link rel="mask-icon" href="/static/images/safari-pinned-tab.svg" color="#0086f4" />
                <meta name="msapplication-TileColor" content="#da532c" />
                <meta name="theme-color" content="#ffffff" />
                ...
                <link href="https://fonts.googleapis.com/css?family=Lato:400,900&display=swap" rel="stylesheet" disabled/>
            ...
            <a className="Discord" target="_blank" href="/discord">
              <i className="Discord-icon Discord-icon--message material-icons">chat</i>
              
              <img className="Discord-icon Discord-icon--plane" src="../../static/images/discord-brand.svg"></img>
              <div className="Discord-text">
                <span>Talk to us on<br/><strong>Discord</strong></span>
              </div>
            </a>
