        ...
        <div id="withdraw">
          <Container>
            ...
            <Grid verticalAlign='middle' textAlign='center' style={{marginTop: '40vh'}}>
              <Header> Please use a Chrome Browser with Metamask enabled to proceed. If you've haven't already, download Chrome <a className='redlink' href="https://www.google.com/chrome/">here</a> and Metamask <a className='redlink' href="https://metamask.io/">here</a> </Header>
            </Grid>
          </Container>
        </div>
      )
              ...
              <Grid.Column>
                <div className="progressbar">
                  <a href="https://decentral.games">
                    <img className="image inline" src={logo} style={{width: '230px', paddingTop: '25px', paddingBottom: '25px'}}/>
                  </a>
                  <Grid.Row style={{paddingTop: '25px', borderTop: '1px solid lightgray'}}>
                    ...
                    <p style={{opacity: '0.5', marginLeft: '2px'}} className="progressbar"> Switch to Matic RPC </p>
                  </Grid.Row>  
                ...
                <div className="contentContainer" style={{padding: '20px', marginTop: '10px', textAlign: 'left'}}>
          ...
          <Grid verticalAlign='middle' textAlign='center'>
            <Grid.Column>
              <div className="progressbar">
                ...
                <Grid.Row style={{marginTop: '15px'}}>
                  <img style={{opacity: '0.5'}} className="progressbar image inline" src={box} />
                  <p style={{opacity: '0.5'}} className="progressbar"> Select Amount </p>
                </Grid.Row>
              </div>
              ...
              <div className="contentContainer" style={{padding: '20px', marginTop: '10px', textAlign: 'left'}}>
                ...
                <img style={{width:'240px', marginLeft: '100px'}} src={verify} className="image small inline" />
...
export default AdminCheck(Withdraw);
