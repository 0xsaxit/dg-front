  ...
  class WithAdmin extends React.Component {
    ...
    componentDidMount() {
			...
			try {
			  ...
			  } else if (Global.ADMINS.includes(window.web3.currentProvider.selectedAddress.toLowerCase())) {
	      ...
	      return (
	        <div id="admin" className="ui accountContainer">
	          <Container>
	            ...
	            <Grid verticalAlign='middle' textAlign='center' style={{marginTop: '39vh'}}>
	              <Header> You must be signed in to metamask with an Administrator address to view this page </Header>
	            </Grid>
	          </Container>
	        </div>
	      );
