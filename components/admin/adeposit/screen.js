        ...
        <div id="deposit">
          <Container>
            ...
            <Grid verticalAlign='middle' textAlign='center' style={{marginTop: '40vh'}}>
              <Header> Please use a Chrome Browser with Metamask enabled to proceed. If you've haven't already, download Chrome <a className='red' href="https://www.google.com/chrome/">here</a> and Metamask <a className='redlink' href="https://metamask.io/">here</a> </Header>
            </Grid>
          </Container>
        </div>
      )
