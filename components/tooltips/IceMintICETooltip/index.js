      ...
      <div className={styles.popup}>
        <div className={styles.tooltipContent}>
          ...
          <p className={styles.popup_content}>
            You must have your ICE on Polygon<br /> to mint this wearable. You can<br /> bridge your ICE from Mainnet to<br /> Polygon <a href="https://wallet.polygon.technology/bridge/" target="_blank">here.</a></p>
        </div>
      </div>
    </div>
  );
