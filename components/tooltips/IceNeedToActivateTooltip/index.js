  ...
  return (
    <div className={styles.fullDiv}>
      <div className={styles.imgDiv}>
        <img className={styles.img} src="https://res.cloudinary.com/dnzambf4m/image/upload/v1631640055/need_to_activate_i60khg.svg" />
        <Popup
          trigger={
        ...
        >
          <Popup.Content className={styles.tooltipContent}>
            ...
            <p className={styles.popup_content}>In order to earn ICE, you must<br /> first activate your wearable. This<br /> is a one time activation cost to<br /> pair it with the DG ecosystem.</p>
          </Popup.Content>
        </Popup>
      </div>
    </div>
