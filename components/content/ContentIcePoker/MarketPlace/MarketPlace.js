...
const MarketPlace = () => {
  ...
  const detailsICELinen = {
    Hat: [
      'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637091409/Linen%20Fit/hat_grey_m_m8dbi3.png',
      'Boater Hat',
      'Linen',
      'Head',
      'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637091409/Linen%20Fit/hat_grey_m_m8dbi3.png',
    ...
    Cigar: [
      'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637091411/Linen%20Fit/pipe_grery_lhnu6p.png',
      'XL Pipe',
      'Linen',
      'Head',
      'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637091411/Linen%20Fit/pipe_grery_lhnu6p.png',
    ...
    Top: [
      'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637091412/Linen%20Fit/shirt_grey_m_e61mwo.png',
      'Linen Shirt',
      'Linen',
      'Torso',
      'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637091412/Linen%20Fit/shirt_grey_m_e61mwo.png',
    ...
    Pants: [
      'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637091410/Linen%20Fit/pants_grey_m_ofahds.png',
      'Linen Pants',
      'Linen',
      'Legs',
      'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637091410/Linen%20Fit/pants_grey_m_ofahds.png',
    ...
    Shoes: [
      'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637091413/Linen%20Fit/shoes_grey_mkdkto.png',
      'Boater Shoes',
      'Linen',
      'Feet',
      'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637091413/Linen%20Fit/shoes_grey_mkdkto.png',
  ...
  const detailsICEBomber = {
    Pants: [
      'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637091242/Bomber%20Fit/pants_grey_m_zfrety.png',
      'Bomber Pants',
      'Bomber',
      'Legs',
      'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637091242/Bomber%20Fit/pants_grey_m_zfrety.png',
    ...
    Hat: [
      'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637091241/Bomber%20Fit/hat_grey_m_ptl8se.png',
      'Bomber Hat',
      'Bomber',
      'Head',
      'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637091241/Bomber%20Fit/hat_grey_m_ptl8se.png',
    ...
    Top: [
      'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637091243/Bomber%20Fit/upperbody_grey_m_exs6ms.png',
      'Bomber Jacket',
      'Bomber',
      'Torso',
      'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637091243/Bomber%20Fit/upperbody_grey_m_exs6ms.png',
    ...
    Glasses: [
      'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637091240/Bomber%20Fit/glasses_grey_qmjxqp.png',
      'Bomber Glasses',
      'Bomber',
      'Accessory',
      'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637091240/Bomber%20Fit/glasses_grey_qmjxqp.png',
    ...
    Shoes: [
      'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637091243/Bomber%20Fit/shoes_grey_gftpjo.png',
      'Bomber Shoes',
      'Bomber',
      'Feet',
      'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637091243/Bomber%20Fit/shoes_grey_gftpjo.png',
  ...
  const previewBomberImages = [
    'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637107740/Bomber%20Fit/Bomber_1_aqjlun.png',
    'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637107740/Bomber%20Fit/Bomber_2_eg3o0c.png',
    'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637107740/Bomber%20Fit/Bomber_3_sxwgci.png',
    'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637107740/Bomber%20Fit/Bomber_4_ad2vxh.png',
    'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637107740/Bomber%20Fit/Bomber_5_ixqifi.png',
  ];
  const previewLinenImages = [
    'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637088369/Linens_1_hqogna.png',
    'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637088370/Linens_2_s3wrak.png',
    'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637088369/Linens_3_qrbcbx.png',
    'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637088370/Linens_4_jgqlue.png',
    'https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1637088370/Linens_5_vplmii.png',
  ];
