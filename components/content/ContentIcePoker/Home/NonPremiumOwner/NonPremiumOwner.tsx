...
const IceDashboardNonPremium = (props: NonPremiumProps): ReactElement => {
    ...
    <section className={cn('row', styles.main_wrapper)}>
      ...
      <div className={cn('col-xl-4', styles.sub_profile)}>
        <div className={cn(styles.lower)}>
          <p className={styles.lower_header}>Play ICE Poker</p>
          <img className={styles.lower_img} src="https://res.cloudinary.com/dnzambf4m/image/upload/v1645784053/Rectangle_1_qnnh9p.png" alt="ice" />
          <Button
        ...
        <div className={styles.lower}>
          ...
          {!isClaimClicked ? (
            <Button
              ...
              disabled={totalIce > 0 ? false : true}
            >
