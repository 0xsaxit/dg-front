            ...
            <Table.Body>
              <Table.Row style={{ background: 'rgba(255, 255, 255, 0.08', width: '200px' }}>
                <Table.Cell className={styles.user_info}>
                  <img src={`https://events.decentraland.org/api/profile/${searchAddress}/face.png`} alt="avatar" />
            ...
            <Table.Body>
              <Table.Row style={{ background: 'rgba(255, 255, 255, 0.08)' }}>
                ...
                <Table.Cell style={{ width: '150px' }}>
                  {gamePlay.checkedIn} of {gameReports.length}
                </Table.Cell>

                {/* Finished Challenges */}
                <Table.Cell style={{ width: '220px' }}>
                  {gamePlay.numChallengesCompleted} of {3 * gameReports.length}
                </Table.Cell>
