    ...
    <Aux>
      ...
      <div className={styles.ice}>
        <div className={styles.ice_card}>
          <ICEDWearableCard
            url = 'https://res.cloudinary.com/dnzambf4m/image/upload/v1629893954/Group_199_gnajsw.png'
            title='ICED Wearables1'
            desc='20% Max ICE Bonus'
            text='DG Deezys'
          />

          <div className={styles.ice_card_buttons}>
            <ModalDelegate />
