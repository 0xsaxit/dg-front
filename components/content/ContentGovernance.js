...
import { Button, Divider, Input, Loader, Popup, Icon, Table, Grid } from 'semantic-ui-react';
                  ...
                  <Table.Row>
                    ...
                    {gameplayAll ? (
                      <span style={{ display: 'flex', justifyContent: 'flex-end' }}>
                        ...
                        <Table.Cell className="treasury-cell two" textAlign='right'>
                  ...
                  <Table.Row>
                    ...
                    {gameplayTreasury ? (
                      <span style={{ display: 'flex', justifyContent: 'flex-end' }}>
                        ...
                        <Table.Cell className="treasury-cell-lower two" textAlign='right'>
