...
const API_ADDRESSES = (async () => {
  ...
  const DG_STAKING_ADDRESS = json.DG_STAKING_ADDRESS;
  const DG_TOKEN_ADDRESS = json.DG_TOKEN_ADDRESS;
  const BP_TOKEN_ADDRESS = json.BP_TOKEN_ADDRESS;
  const TOMINOYA_ADDRESS = json.TOMINOYA_ADDRESS;
  ...
  console.log('DG_STAKING_ADDRESS: ' + DG_STAKING_ADDRESS);
  console.log('DG_TOKEN_ADDRESS: ' + DG_TOKEN_ADDRESS);
  console.log('BP_TOKEN_ADDRESS: ' + BP_TOKEN_ADDRESS);
  console.log('TOMINOYA_ADDRESS: ' + TOMINOYA_ADDRESS);
