...
const ADDRESSES = (() => {
  ...
  const TOKEN_ADDRESS_UNISWAP = '0x44c21f5dcb285d92320ae345c92e8b6204be8cdf';
  const UNISWAP_ADDRESS_WRAPPED_ETH = '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2';
  ...
  console.log('TOKEN_ADDRESS_UNISWAP: ' + TOKEN_ADDRESS_UNISWAP);
  console.log('UNISWAP_ADDRESS_WRAPPED_ETH: ' + UNISWAP_ADDRESS_WRAPPED_ETH);
  ...
  return {
    ...
    BP_TOKEN_ADDRESS_1,
    BP_TOKEN_ADDRESS_2,
    TOKEN_ADDRESS_UNISWAP,
    UNISWAP_ADDRESS_WRAPPED_ETH,
