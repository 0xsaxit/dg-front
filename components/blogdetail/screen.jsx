        ...
        <Segment style={{ backgroundColor: 'white' }}>
          <Container>
            ...
            <div className="post__content" style={{ marginTop: '-60px' }}>{HtmlParser(body)}</div>
              ...
              <div className="date1" style={{ marginTop: '-15px', marginBottom: '150px' }}>
                <span>
            ...
            <div className="blog-page read-next-container" style={{ paddingTop: '90px', paddingBottom: '60px', marginBottom: '-60px', backgroundColor: '#F6F8F9' }}>
              <Container className="test-container">
                <h2 className="read-next-text"> Read Next </h2>
                <div className="posts-2 read-next" style={{ backgroundColor: 'red' }}>
                  {
                    randomfilteredPages && randomfilteredPages.map(page => (
                      <PostPreview
                        key = {page.created}
                        title={page.title}
                        summary=""
