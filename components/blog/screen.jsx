              ...
              <Menu borderless style={{ border: 'none', boxShadow: 'none' }} className="blog-nav-menu">
                <Link href="/">
                  <Menu.Item header style={{ marginLeft: '-15px' }}>
                    <Image src="https://res.cloudinary.com/dnzambf4m/image/upload/v1588362125/authorize_title_fx3yxd.webp" style={{ width: '42px', marginTop: '1.5em' }} />
                  </Menu.Item>
                </Link>
                <Link href="/">
                    ...
                    <Grid style={{ paddingBottom: '120px' }} className="featured-post-padding">
                      <Grid.Row>
                        <Grid.Column computer={11} tablet={16} mobile={16}>
                          <Image src="https://res.cloudinary.com/dnzambf4m/image/upload/v1588364844/tominoya_feature_lcfdm6.png" className="featured-image"/>
                        </Grid.Column>
                          ...
                          <div className="post-info">
                            ...
                            <div className="bottom">
                              <div className="blog-title">
                                ...
                                <p style={{ color: 'rgb(97, 97, 97)' }}>Tominoya is a 3D virtual casino built by Decentral Games on 52 LAND parcels within Decentraland's Vegas City district.</p>
                              </div>
                            </div>
                          </div>
                        </Grid.Column>
