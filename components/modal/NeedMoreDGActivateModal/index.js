    ...
    <>
      ...
      >
        ...
        <div className={styles.desc}>
            ...
            <span className={styles.link}> with us</span> or use <span className={styles.link}>matic bridge</span>.
        </div>

        <div className={styles.logo}>
            <img src="https://res.cloudinary.com/dnzambf4m/image/upload/v1629894323/Group_8_es81yz.png" alt="logo" />
        </div>
