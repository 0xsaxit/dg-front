...
import verify5_1 from '../../static/images/switch_matic_1.png';
import verify5_2 from '../../static/images/switch_matic_2.png';
                  ...
                  <img className="modal-logo" src={logo} />
                    <Grid.Row >
                      ...
                      <Grid.Row style={{ marginTop: '15px' }}>
                        ...
                        <p className="progressbar p-text"> Deposit to Matic </p>
                      </Grid.Row>
                    </div>
                    ...
                    <div className="modal-content-container" >
                      <Grid>
                        ...
                        <Grid.Row>
                          <p className="modal-p">2. Select amount to deposit MANA to Matic.
                          </p>
                        </Grid.Row>
                          ...
                          <Table id='header' singleLine fixed style={{marginBottom: 0, border: '0px' }}>
                            <Table.Body>
                                <div style={{ paddingTop: '6px', paddingBottom: '17px' }}>
                                  <Table.Row>
                                    <span style={{ color: 'black', textAlign: 'left', lineHeight: '25px', verticalAlign: 'middle', fontWeight: 'bold' }}>
                                      ROPSTEN BALANCE:
                                    </span>
                                    <img style={{ verticalAlign:'middle', marginLeft: '40px' }} width="20px" height="20px" src={mana} />
                                    <span style={{ color: 'black', textAlign: 'left', marginLeft: '10px', lineHeight: '25px', verticalAlign: 'middle'}}>
                                  ...
                                  <Table.Row>
                                    ...
                                    <img style={{ verticalAlign:'middle', marginLeft: '63px' }}  width="20px" height="20px" src={mana} />
                                    <span style={{ color: 'black', textAlign: 'left', marginLeft: '10px', lineHeight: '25px', verticalAlign: 'middle' }}>
            ...
            <Grid verticalAlign='middle' textAlign='center'>
              <Grid.Column>
                <div className="progressbar2">
                  ...
                  <Grid.Row style={{ marginTop: '15px' }}>
                    <img style={{ opacity: '0.5' }} className="progressbar-image-box" src={box} />
                    <p style={{ opacity: '0.5' }} className="progressbar p-text"> Deposit to Matic </p>
                  </Grid.Row>
                </div>
                ...
                <div className="modal-content-container" >
                  <Grid>
                    ...
                    <Grid.Row>
                      <p className="modal-p">1. On your Metamask extension, open the Network dropdown menu and select 'Ropsten'.
                      </p>
                    </Grid.Row>
                    <Grid.Row>
                  ...
                  <div className="progressbar2">
                    ...
                    <Grid.Row >
                      ...
                      <Grid.Row style={{ marginTop: '15px' }}>
                        <img style={{ opacity: '0.5' }} className="progressbar-image-box" src={box} />
                        <img style={{ opacity: '0.5' }} className="progressbar-image-check" src={check} />
                        <p style={{ opacity: '0.5', paddingLeft: '0px' }} className="progressbar p-text"> Deposit to Matic </p>
                      </Grid.Row>
                      <Grid.Row style={{ marginTop: '15px' }}>
                        <img style={{ opacity: '0.5' }} className="progressbar-image-box" src={box} />
                        <img style={{ opacity: '0.5' }} className="progressbar-image-check" src={check} />
                        <p style={{ opacity: '0.5', paddingLeft: '0px' }} className="progressbar p-text"> Configure Matic RPC </p>
                      </Grid.Row>
                      <Grid.Row style={{ marginTop: '15px' }}>
                        <img className="progressbar-image-box" src={box} />
              ...
              <Grid.Column>
                <div className="progressbar2">
                  ...
                  <Grid.Row style={{ marginTop: '15px'} }>
                    ...
                    <Grid.Row style={{ marginTop: '15px' }}>
                      <img className="progressbar-image-box" src={box} />
                      <p className="progressbar p-text"> Configure Matic RPC </p>
                    </Grid.Row>
                    <Grid.Row style={{marginTop: '15px'}}>
                      <img style={{ opacity: '0.5' }} className="progressbar-image-box" src={box} />
                      <p style={{ opacity: '0.5' }} className="progressbar p-text"> MANA Authorization </p>
                    </Grid.Row>
                  </div>
                  ...
                  <div className="modal-content-container">
                    <Grid>
                      ...
                      <Grid.Row>
                        <p className="modal-p">1.</p>
                        <img style={{ width:' 190px', marginLeft: '-40px', marginRight: '30px' }} src={verify5_1} />
                        <p className="modal-p">2.</p>
                        <img style={{ width: '190px', verticalAlign: 'top', marginLeft: '-40px' }} src={verify5_2} />
                ...
                <Grid.Column>
                  <div className="progressbar2">
                    ...
                    <Grid.Row >
                      ...
                      <img style={{ opacity: '0.5' }} className="progressbar-image-box" src={box} />
                      <img style={{ opacity: '0.5' }} className="progressbar-image-check" src={check} />
                      <p className="progressbar p-text" style={{ opacity: '0.5', paddingLeft: '0px' }}> Switch to Ropsten RPC </p>
                    </Grid.Row>  
                    <Grid.Row style={{ marginTop: '15px' }}>
                      <img className="progressbar-image-box" src={box} />
                      <p className="progressbar p-text"> Deposit to Matic </p>
                    ...
                    <Grid.Row style={{ marginTop: '15px' }}>
                      <img style={{ opacity: '0.5' }} className="progressbar-image-box" src={box} />
                      <p style={{ opacity: '0.5' }} className="progressbar p-text"> Configure Matic RPC </p>
                    </Grid.Row>
                    <Grid.Row style={{ marginTop: '15px' }}>
                      <img style={{ opacity: '0.5' }} className="progressbar-image-box" src={box} />
                      <p style={{ opacity: '0.5' }} className="progressbar p-text"> MANA Authorization </p>
                    ...
                    <div className="modal-content-container" >
                      <Grid>
                        ...
                        <Grid.Row>
                          <p className="modal-p">2. Authorize MANA transfers and deposit to Matic.
                          </p>
                        </Grid.Row>
                        <Grid.Row>
                          { this.state.isCustomAmount == 0 ?
        ...
        <div id="deposit">
          ...
          <div className="ui depositContainer">
            <Grid verticalAlign='middle' textAlign='center'>
              <Grid.Column>
                <div className="progressbar2">
                  <img className="image inline" src={logo} className="modal-logo" />
                  <Grid.Row >
                    <Divider className="modal-divider" />
                    <img className="progressbar-image-box" src={box} />
