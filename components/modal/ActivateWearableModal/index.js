    ...
    <>
      ...
      >
        ...
        <div className={styles.title}>
            <img className={styles.metamask} src="https://res.cloudinary.com/dnzambf4m/image/upload/v1620331579/metamask-fox_szuois.png" />
            Activate Wearable
        </div>
        <div className={styles.desc}>
          To activate your ICE wearable, you’ll have to complete 2 transactions in metamask.
        </div>
