...
const ActivateWearableModal = props => {
  // fetch ... data from the Context API store
  ...
  async function metaTransaction() {
    console.log('Meta-transaction Re-ICE');
    setClicked(true);
    ...
    try {
      ...
      console.log('Re-ICE error: ' + error);
    }
  }
      ...
      {!pending ?
        ...
        >
          ...
          <div className={styles.desc}>
            To activate your wearable, confirm your purchase<br /> and complete the metamask transaction.
          </div>
          <div className={styles.dgSection}>
            ...
            <p>{parseFloat(state.DGBalances.BALANCE_CHILD_DG).toFixed(1)} DG Available <br /><abbr>(On Polygon)</abbr></p>
          </div>
