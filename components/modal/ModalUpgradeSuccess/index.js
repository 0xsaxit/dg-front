        ...
        <div className={styles.success_container}>
          ...
          <div className={styles.card}>
            <div className={styles.toppercent}>
              +31%
            <img src="https://res.cloudinary.com/dnzambf4m/image/upload/v1631326183/ICE_Diamon_ICN_k27aap.png" style={{ width: '20px', marginLeft: '3px' }} />
            </div>
            ...
            <div className={styles.properties}>
              ...
              <div className={styles.round}>
                +31%
              <img src="https://res.cloudinary.com/dnzambf4m/image/upload/v1631326183/ICE_Diamon_ICN_k27aap.png" style={{ width: '14px', marginLeft: '2px' }} />
              </div>
              <div className={styles.round}>
                1 of 100
            </div>
