    ...
    return (
      <Aux>        
        <div className={styles.logo}>
          <img
            src="https://res.cloudinary.com/dnzambf4m/image/upload/v1636423902/check-mark_fvx9a4.png"            
          />
        </div>
      </Aux>
    );
  ...
  function dgSection() {
    ...
    return (
      <Aux>
          <div className ={styles.body_section}>
            ...
            <div className={styles.dg_plus}>
                <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path 
                        d="M6.3471 0.11419H3.8171V3.39219H0.561096V5.92219H3.8171V9.17819H6.3471V5.92219H9.6251V3.39219H6.3471V0.11419Z" 
                        fill="white"
                    />
                </svg>
            </div>
        ...
        {!authStatus && (<div className={styles.buttons}>
            <Button
              disabled = {loading}
