        ...
        <div className={styles.delegate_container}>
          ...
          <div className={styles.wear_box_right} >
                ...
                <div className={styles.card_area}>
                  <div className={styles.card_area_body} style={{width: '100%'}}>
                    <div className={styles.inputcard}>
                      To:
                      <input className={styles.input} maxLength="42" placeholder="Paste ETH Address Here" onChange={(evt)=> {
            ...
            <div className={styles.delegateInfo}>
              Address already has delegated wearables. Only 1 person can delegate at a time.
            </div>
          </div>          
        </div>
      </Modal>) : (
