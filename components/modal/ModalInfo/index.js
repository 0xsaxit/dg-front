    ...
    >
      ...
      <div>
        <span>
          ...
          <span style={{ display: 'flex', justifyContent: 'space-between', padding: '6px 12px 0px 12px' }}>
            <span style={{ display: 'flex', flexDirection: 'column' }}>
              <h5 className={styles.row_title}>
                Mainchain DG
              </h5>
          ...
          <span style={{ display: 'flex', justifyContent: 'space-between', padding: '0px 12px 0px 12px' }}>
            <span style={{ display: 'flex', flexDirection: 'column' }}>
              <h5 className={styles.row_title}>
                Polygon Wallet DG
              </h5>
              <p className={styles.row_subtitle}>
                Polygon Network Total
              </p>
            </span>
          ...
          <span style={{ display: 'flex', justifyContent: 'space-between', padding: '0px 12px 6px 12px' }}>
            <span style={{ display: 'flex', flexDirection: 'column' }}>
              <h5 className={styles.row_title}>
                Unclaimed DG
              </h5>
