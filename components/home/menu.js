  ...
  render() {
    return (
      <Menu className="menu-container" icon='labeled' vertical>
        <a href="/">
          <img className="image inline" src="https://res.cloudinary.com/dnzambf4m/image/upload/v1589058640/authorize_title_v3ze35.png" style={{width: '42px', paddingTop: '30px', paddingBottom: '35px'}}/>
        </a>
        ...
        { this.props.dashboard === true ? <Menu.Item href="/txhistory" exact="true" className='sidebar-menu-text'>
          <span> <MdHistory style={{ fontSize: '30px', paddingBottom: '6px' }}/></span><br />
          TX History
        </Menu.Item> : <p></p> }
        { this.props.dashboard === true ? <Menu.Item href="/nfts" exact="true" className='sidebar-menu-text' style={{color:'grey'}}>
