...
const Farming = (props) => {
  ...
  /////////////////////////////////////////////////////////////////////////////////////////
  /////////////////////////////////////////////////////////////////////////////////////////
  // stake, withdraw, and get reward from governance contract
  async function stakingGovernance(amount) {
    ...
    try {
      ...
      const data = await stakingContractGovernance.methods
        .stake(amountToString)
        .send({ from: userAddress });
  ...
  async function getRewardGovernance() {
    console.log('Call getRewardGovernance() function to claim DG tokens');
    ...
    try {
      ...
      const data = Transactions.getReward(
        stakingContractGovernance,
        userAddress
      );

      console.log(
        'getRewardGovernance() transaction completed: ' + data.transactionHash
      );
      ...
      console.log('getRewardGovernance() transaction error: ' + error);
    }
  }
