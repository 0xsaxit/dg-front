        ...
        {!state.userStatus ? (
          ...
          <div className="home-dashboard-content">
            ...
            <p className="home-dashboard-p" style={{ marginTop: '18px' }}>
              Serenity Island is a Monty Carlo-inspired metaverse casino built by Decentral Games in Decentraland. Enjoy non-custodial slots, roulette, and blackjack playable with crypto.
            </p>
