            ...
            <div style={{ display: 'flex' }}>
              <div className={styles.token_container}>
                ...
                <div className={styles.tokenBalance}>
                  <p className={styles.title}>
                    {' '}
                    ICE Earned <AccountTooltip data={'ICE Earned'} />
                  </p>
              ...
              <div className={styles.token_container}>
                ...
                <div className={styles.tokenBalance}>
                  <p className={styles.title}>
                    {' '}
                    XP Earned <AccountTooltip data={'XP Earned'} />
                  </p>
              ...
              <div className={styles.token_container}>
                ...
                <div className={styles.tokenBalance}>
                  <p className={styles.title}>
                    {' '}
                    DG Mined <AccountTooltip data="DG Mined" />
                  </p>
              ...
              {!!state.DGBalances?.BALANCE_AFFILIATES.length &&
                (dataType === 'referrals' ? (
                  ...
                  <Link href="/account/referrals">
                    <span className={cn('account-hover', styles.account_hover)}>Referrals</span>
                  </Link>
                ))}
            </span>
          </div>
