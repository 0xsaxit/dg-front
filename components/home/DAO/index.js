...
const DAO = (props) => {
  ...
  function submenu() {
    return (
      <>
        {/* <Menu width={280} isOpen={true}>
          <a id="home" className="menu-item" href="/">Home</a>
          <a id="about" className="menu-item" href="/about">About</a>
          <a id="contact" className="menu-item" href="/contact">Contact</a>
          <a onClick={this.showSettings} className="menu-item--small" href="">Settings</a>
        </Menu>
        <div id="page-wrap">My name is KJS</div> */}
        {
          isMobile && !mobileOpen ? (
            <div className={styles.tablet_menu_container}>
              ...
              <div className={styles.menu_list}>
                ...
                <div>
                  <Link href="/dg">
                    <div className={DGState === 'overview' ? styles.menu_item_active : styles.menu_item} style={{ marginTop: '-2px' }}>
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7.24463 14.7815L10.2378 10.8914L13.652 13.5733L16.581 9.79297" stroke="white" stroke-opacity="0.5" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <circle cx="19.9954" cy="4.20027" r="1.9222" stroke="white" stroke-opacity="0.5" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M14.9243 3.12012H7.65655C4.64511 3.12012 2.77783 5.25284 2.77783 8.26428V16.3467C2.77783 19.3581 4.6085 21.4817 7.65655 21.4817H16.2607C19.2721 21.4817 21.1394 19.3581 21.1394 16.3467V9.30776" stroke="white" stroke-opacity="0.5" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                  ...
                  <Link href="/dg/treasury">
                    <div className={DGState === 'treasury' ? styles.menu_item_active : styles.menu_item}>
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M22 12C22 10.6868 21.7413 9.38642 21.2388 8.17317C20.7362 6.95991 19.9997 5.85752 19.0711 4.92893C18.1425 4.00035 17.0401 3.26375 15.8268 2.7612C14.6136 2.25866 13.3132 2 12 2V12H22Z" stroke="white" stroke-opacity="0.5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                      <div className={styles.menu_title}>
                        Treasury
                      </div>
                  ...
                  <Link href="/dg/governance">
                    <div className={DGState === 'governance' ? styles.menu_item_active : styles.menu_item}>
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M15 2H9C8.44772 2 8 2.44772 8 3V5C8 5.55228 8.44772 6 9 6H15C15.5523 6 16 5.55228 16 5V3C16 2.44772 15.5523 2 15 2Z" stroke="#808080" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        <line x1="9" y1="16" x2="15" y2="16" stroke="white" stroke-opacity="0.5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        <line x1="9" y1="12" x2="15" y2="12" stroke="white" stroke-opacity="0.5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                      <div className={styles.menu_title}>
                        Gover<br />nance
                      </div>
                  ...
                  <Link href="/dg/mining">
                    <div className={DGState === 'mining' ? styles.menu_item_active : styles.menu_item}>
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 15C15.866 15 19 11.866 19 8C19 4.13401 15.866 1 12 1C8.13401 1 5 4.13401 5 8C5 11.866 8.13401 15 12 15Z" stroke="#808080" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M8.21 13.8899L7 22.9999L12 19.9999L17 22.9999L15.79 13.8799" stroke="#808080" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                      <div className={styles.menu_title}>
                        Gameplay Rewards
                      </div>
                  ...
                  <Link href="/dg/liquidity">
                    <div className={DGState === 'liquidity' ? styles.menu_item_active : styles.menu_item}>
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 1V23" stroke="white" stroke-opacity="0.5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M17 5H9.5C8.57174 5 7.6815 5.36875 7.02513 6.02513C6.36875 6.6815 6 7.57174 6 8.5C6 9.42826 6.36875 10.3185 7.02513 10.9749C7.6815 11.6313 8.57174 12 9.5 12H14.5C15.4283 12 16.3185 12.3687 16.9749 13.0251C17.6313 13.6815 18 14.5717 18 15.5C18 16.4283 17.6313 17.3185 16.9749 17.9749C16.3185 18.6313 15.4283 19 14.5 19H6" stroke="#808080" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                      <div className={styles.menu_title}>
                        Liquidity Provision
                      </div>
            ...
            //       <div />
            //     </div>
            //     <div className={cn(styles.menu_list, mobileOpen ? styles.mobile_open : styles.mobile_close)}>
  ...
  return (
    <div style={{ marginTop: '-60px', marginBottom: '240px' }}>
      <div>
        ...
        <div style={{ marginTop: '-200vh', width: isMobile ? 'calc(100% - 80px)' : 'calc(100% - 300px)', float: 'right' }}>
