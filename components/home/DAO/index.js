                  ...
                  <div className={styles.menu_item} style={{ marginTop: '2px' }}>
                    ...
                    >
                      <path
                        ...
                        stroke="white"
                        stroke-opacity={DGState === 'overview' ? 1 : 0.5}
                        stroke-width="1.5"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                      />
                  ...
                  >
                    ...
                    >
                      <path
                        ...
                        stroke="white"
                        stroke-opacity={DGState === 'treasury' ? 1 : 0.5}
                        stroke-width="2"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                      />
                  ...
                  <div className={styles.menu_item}>
                    ...
                    >
                      <path
                        ...
                        stroke="white"
                        stroke-opacity={DGState === 'governance' ? 1 : 0.5}
                        stroke-width="2"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                      />
                  ...
                  <div className={styles.menu_item}>
                    ...
                    >
                      <path
                        ...
                        stroke="white"
                        stroke-opacity={DGState === 'mining' ? 1 : 0.5}
                        stroke-width="2"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                      />
                  ...
                  <div className={styles.menu_item}>
                    ...
                    >
                      <path
                        d="M12 1V23"
                        stroke="white"
                        stroke-opacity={DGState === 'uniswap' ? 1 : 0.5}
                        stroke-width="2"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                      />
